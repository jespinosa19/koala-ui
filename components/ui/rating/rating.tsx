...
// polish: a star is 16-24px, under the 40px hit target (#9). `hitY` (lib/hit-area.ts) extends the
// click area *vertically only*, 40px on desktop and 44 on touch: extending horizontally would
// overlap the adjacent star (#16).

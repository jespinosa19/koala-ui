...
export const galleryAccordionVariants = tv({
  slots: {
    ...
    // The open/close affordance: a Plus that rotates 45° into an ✕ on open. One glyph turning, so
    // it takes `caret-turn` like every other disclosure mark. Motion only — it keeps its neutral

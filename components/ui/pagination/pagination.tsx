    ...
    >
      ...
      >
        <SelectTrigger
          ...
          // tabular-nums: the trigger is w-auto, so 10 → 50 would otherwise resize it.
          className="w-auto gap-2 tabular-nums"
        >
          <SelectValue placeholder="Rows" />
        </SelectTrigger>
        <SelectContent density={control.select} className="tabular-nums">

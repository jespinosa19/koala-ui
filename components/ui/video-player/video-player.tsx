...
export const videoPlayerVariants = tv({
  slots: {
    ...
    seekRoot:
      "group/seek relative flex h-4 w-full grow touch-none items-center select-none before:absolute before:inset-x-0 before:top-1/2 before:h-10 before:-translate-y-1/2 before:content-[''] pointer-coarse:before:h-11",
    seekTrack:

...
// ─── ColorPickerControls (the rails) ────────────────────────────────────────────────

/**
 * The hue rail with the alpha rail stacked under it. It carries no preview chip: the square
 * directly above already shows the colour at full size, so a second swatch was redundant.
 * `ColorPickerPreview` stays exported for layouts that do want one.
 */

 ...
 * copy/icon with props, and pass the single action (an outline Button) as `children`.
 */
const PRESETS = {
  empty: {
...
export interface DataTableEmptyProps {
  ...
  /** The one action, an outline Button rendered below the copy (e.g. "Clear filters"). */
